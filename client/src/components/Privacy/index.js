...
function Privacy() {
    ...
    <p>This Privacy Policy (the “Privacy Policy”) applies to Evoke Neurodiagnostics (“we”, “our” and “us”), the developer and owner of the Evoke Brain Training App (the “Software” or “App”). It explains how Evoke Neurodiagnostics LLC collects, uses, stores and discloses information about users (“users”, “you” and “your”) through our Evoke Brain Training software/App, websites, forums, blog, social media, web applications and other products and services (collectively, the “Services”) or when you otherwise interact with us.</p>
    <p>This Privacy Policy will help you understand how we use and protect the data you provide to us when you visit and use the Evoke Brain Training App.</p>
    ...
    <p><strong>Information You Provide to Us</strong>We collect information you provide directly to us. This may include:</p>
    <ul>
    ...
    <p><strong>Automatically Collected Information</strong>When you access or use the Software or the Services, we automatically collect information about you, which may include, but is not limited to:</p>
    <ul>
        <li><u>Log Information:</u>We may collect log information about your use of the Software and the Services, including the type of browser you use, access times and your IP address.</li>
        <li><u>Device Information:</u>We may collect information about the computer or mobile device you use to access the Software and our Services, including the hardware model, operating system and version, unique device identifiers, and mobile network information.</li>
    </ul>
    
    <p><strong>Information from Other Sources</strong>We may obtain information from other sources, including third parties, and combine that with information we collect through the Software and the Services.</p>
    
    <p><strong>Information We Will Never Collect</strong>We will never ask you to share your account password. Never trust anyone that asks you to disclose your password. Do not be fooled if someone reaches out to you pretending to be from us.</p>
...
We follow generally accepted standards to protect the personal information submitted to us, both during transmission and once we receive it. No method of transmission over the Internet, or method of electronic storage, is one hundred percent (100%) secure, however. Therefore, we cannot guarantee its absolute security.
    ...
    <h2>Data Retention, Verification, and Deletion</h2>
    ...
    <h2>Disclaimer About Sharing Personal Information Online</h2>
    ...
    <p><strong>Legal Basis for Processing</strong>If you are a resident of the EEA, when we process your personal data, we will only do so in the following situations:</p>
    <ol>
    ...
    <p><strong>Product Research Opt-out</strong>Occasionally, we may contact you regarding opportunities to participate in product research, surveys, or other product testing. We will provide you with clear and concise instructions, specific to the method we use to contact you, regarding how to opt-out of product research communications.</p>
    ...
    <h2>Our Policies for Children</h2>
        <p>Our products, the Software and the Services, are only directed to persons of the age of 13 or over. We are committed to protecting the online privacy of children under the Children’s Online Privacy Protection Act (COPPA). We will not knowingly collect any personal identifiable information from children under 13 without first obtaining parental consent. If we become aware that we have unknowingly collected personal information from an individual under the age of 13, we will make commercially reasonable efforts to delete such personal information from our records. If you are concerned and are aware of a user under the age of 13 using the Software, the Services or our products, please contact us by contacting us as indicated in the “Contact Us” section below.</p>
